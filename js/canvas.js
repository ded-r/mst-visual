    ...
    constructor() {
        ...
        this.updateEdge = () => {
            for (let i in this.directedEdges) {
                ...
                if (xMedia >= 0 || this.directedEdges[i].start.posX <= this.directedEdges[i].end.posX) xMedia *= (-1);
                if (yMedia >= 0 || this.directedEdges[i].start.posY <= this.directedEdges[i].end.posY) yMedia *= (-1);
...
const addVertex = document.getElementById('addVertex');
const addUndirectedEdge = document.getElementById('addUndirectedEdge');
const addDirectedEdge = document.getElementById('addDirectedEdge');
const moveNode = document.getElementById('moveNode');
const addNewGraph = document.getElementById('addNewGraph');
const edit = document.getElementById('edit');
const remove = document.getElementById('remove');
const executeAlgo = document.getElementById('executeAlgo');
...
document.addEventListener('DOMContentLoaded', () => {
    init();
    addVertex.addEventListener('click', () => selectItem(addVertex, 1));
    addDirectedEdge.addEventListener('click', () => selectItem(addDirectedEdge, 3));
    addUndirectedEdge.addEventListener('click', () => selectItem(addUndirectedEdge, 4));
